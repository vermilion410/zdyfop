...
type Interface interface {
	...
	ZdyfapiV1alpha1() zdyfapiv1alpha1.ZdyfapiV1alpha1Interface
	// Deprecated: please explicitly pick a version if possible.
	Zdyfapi() zdyfapiv1alpha1.ZdyfapiV1alpha1Interface
}
...
func (c *Clientset) Zdyfapi() zdyfapiv1alpha1.ZdyfapiV1alpha1Interface {
	return c.zdyfapiV1alpha1
}
...
func NewForConfigOrDie(c *rest.Config) *Clientset {
	var cs Clientset
	cs.zdyfapiV1alpha1 = zdyfapiv1alpha1.NewForConfigOrDie(c)
...
func New(c rest.Interface) *Clientset {
	var cs Clientset
	cs.zdyfapiV1alpha1 = zdyfapiv1alpha1.New(c)
